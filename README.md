# Management-System
🍽 Python Restaurant Management System (CLI)This project is a simple, command-line interface (CLI) application developed in Python to simulate basic operations of a restaurant management system. It uses Object-Oriented Programming (OOP) principles to handle menu display, order placement, status tracking, and bill generation.
